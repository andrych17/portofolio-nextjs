...
- Senior Fullstack & AI Engineer based in Surabaya, Indonesia, with ${yearsExp}+ years of professional engineering experience.
...
- Career History:
  * Freelance Fullstack & AI Engineer, self-employed, Surabaya (Remote) (2021 - Present, full-time since Mar 2026): Qualiv AI recruitment SaaS, PT Nagamasban AI sales assistant, OpenClaw security agent, Wonderful Works website & CMS, and Laravel ERP/POS systems for retail clients.
  * Fullstack Developer at MRI Software (formerly Anacle Systems Ltd), Singapore (Remote) (Nov 2022 - Mar 2026): Built features for enterprise SaaS platforms (Anacle Simplicity & SMRT Tenant Management System) through go-live, built 100k+ file document migration engine (SharePoint Graph API, AWS S3, Azure Blob), deployed production RAG pipelines (OpenAI & PostgreSQL pgvector), automated Playwright/Selenium regression tests, and led SonarQube zero-vulnerability CI/CD quality gates.
  * Fullstack Developer at Software House, Surabaya (Mar 2022 - Nov 2022): Enterprise Java 17 / Spring Boot Tool Management System (TMS), repaired 10,000+ corrupted records, cut recurring high-priority incidents, and managed Elasticsearch & self-hosted Git servers.
  ...
  * Qualiv (qualiv.id), built during freelance work: Multi-tenant AI recruitment SaaS featuring automated LLM CV screening (PDF/DOCX), candidate logic testing, AI chat & video interview simulations, BullMQ Redis worker, Cloudflare R2, and Midtrans billing.
  * Key Projects: Qualiv (qualiv.id), Wonderful Works Construction (wwconstruction.id), OpenClaw (autonomous AI Linux VPS security agent with fail2ban & Telegram alerts), PT Nagamasban AI Sales Assistant (katalog.nagamasban.com), CG Home Sharing (Airbnb-style room booking with Leaflet GIS maps & NIJ verification), Jewelry Store POS with RFID, Tire Shop ERP with A/R & A/P ledger, Yarn E-Commerce & Retail POS.
...
- Certifications: 11 verified credentials including 9 Anthropic Interactive Skilljar Certifications (Building with Claude API, MCP Architecture, Agent Skills, Subagents, etc.), Coursera AI Agents with MCP (Vanderbilt Univ), and Udemy Large Scale Systems Architecture.
